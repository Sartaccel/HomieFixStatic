  ...
  return (
    ...
    <div className='content-wrapper'>
      ...
      <div className='text-container'>
        ...
        <p>With the HomieFix mobile app, booking home services has never been easier. Find trusted professionals, schedule
          appointments, and track your service requests.
        </p>
        </div>
        <div className='features-grid'>
        <div className='feature'>
          <img src={calender} alt="calender" className='icon'/>
          <div>
        ...
        <div className='feature'>
          <img src={doll} alt="doll" className='icon'/>
          <div>
    ...
    <div className='qr-section'>
      ...
      <a href="https://play.google.com/store/apps/details?id=com.homiefix.homiefix_application"
